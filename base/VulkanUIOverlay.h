...
namespace vks 
{
	...
	public:
		...
		struct RayOption {
			alignas(4) bool shadowRay = true;
			alignas(4) bool reflection = true;
			alignas(4) bool refraction = true;
		};
        ...
        void draw(const VkCommandBuffer commandBuffer, const vks::Buffer& vertexBuffer, const vks::Buffer& indexBuffer);
